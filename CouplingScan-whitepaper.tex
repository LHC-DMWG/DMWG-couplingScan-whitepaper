...
% AB: is the following what was intended? otherwise it is unclear
...
% ABB: restate in a way that makes clear the following was developed by co-authors and not owned by CMS? and that we are not speaking for/guaranteeing that ATLAS has/is going to use this for all/future summary plots? The following modifications are a suggestion for how to do it
...
%It is being documented here for public clarity. % AB: this raises the question why CMS doesn't publish it in some form on its own. If this were an ATLAS method, I suspect ATLAS would not be happy to see a few-author whitepaper claiming to document work by ATLAS.
