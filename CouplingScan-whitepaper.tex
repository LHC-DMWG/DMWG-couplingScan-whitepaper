...
\begin{equation}
d_\text{ex}^\prime = g^2_\text{lim} (\frac{\tilde{\sigma}(g_q=1)}{\tilde{\sigma}^\prime})\,,
\end{equation}
all of which quantities can be calculated for a grid of (\mMed, \mdm) values from the one input curve. The dilepton equivalent is % TODO
