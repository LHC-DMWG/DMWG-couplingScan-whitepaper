...
% Model relevance - vector/AV only, because di-x is not a strong constraint on scalar/pseudoscalar models, so we aren't worrying about it
...
% Illustrate with a plot? Or not, could do just math here and an illustration in the dilepton section ....
...
% Kate still needs to implement this in the code
