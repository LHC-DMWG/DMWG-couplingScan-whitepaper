...
% Note that for visible physical signature, this 1D limit is sufficient because DM mass has very minimal effect on signature in detector. All it can change is width (to be discussed shortly) and cross section (which is what we are rescaling anyway).
